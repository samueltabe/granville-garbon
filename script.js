document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            'faq.q1': 'Who should attend this workshop? <i class="fa-solid fa-chevron-down"></i>',
            ...
            'faq.q2': 'Is attendance free? <i class="fa-solid fa-chevron-down"></i>',
            'faq.a2': 'Yes, attendance is free for qualified organisations, but registration is mandatory as seats are limited.',
            'faq.q3': 'What language will be used? <i class="fa-solid fa-chevron-down"></i>',
            'faq.a3': 'The workshop will primarily be conducted in French, with English support available.',
            'faq.q4': 'What information should we prepare? <i class="fa-solid fa-chevron-down"></i>',
        ...
        fr: {
            ...
            'faq.q1': "Qui doit assister a cet atelier ? <i class='fa-solid fa-chevron-down'></i>",
            'faq.a1': "Representants des ministeres, hopitaux, universites, autorites locales et entreprises disposant d'espaces de toiture.",
            'faq.q2': "L'assistance est-elle gratuite ? <i class='fa-solid fa-chevron-down'></i>",
            ...
            'faq.q3': "Quelle langue sera utilisee ? <i class='fa-solid fa-chevron-down'></i>",
            'faq.a3': "L'atelier se deroulera principalement en francais, avec un support en anglais.",
            'faq.q4': "Quelles informations devons-nous preparer ? <i class='fa-solid fa-chevron-down'></i>",
